...
public class AddDevice_Service extends
		AsyncTask<String, Void, AddDevice_Response> {
	...
	protected AddDevice_Response doInBackground(String... params) {
		...
		AddDevice_Response cba = CommunicationCenter.callPostService(
				nomeServico, adro, AddDevice_Response.class);
		return cba;
	}
